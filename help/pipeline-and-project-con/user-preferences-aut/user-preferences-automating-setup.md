...
![XMLファイルアイコン](user-preferences-automating-setup.resources/user-preferences-automating-setup-01.png "XMLファイルアイコン")
...
![プロジェクト設定](user-preferences-automating-setup.resources/user-preferences-automating-setup-02.png "プロジェクト設定")
...
![実行可能ファイルプロパティの構成ファイルの入力](user-preferences-automating-setup.resources/user-preferences-automating-setup-03.jpg "実行可能ファイルプロパティの構成ファイルの入力")
