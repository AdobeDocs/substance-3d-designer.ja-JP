...
![書き出されたシーンファイル – 統合](exporting-scenes.resources/exportFlattened.png "書き出されたシーンファイル – 統合"){zoomable="yes"}
...
![書き出されたシーンファイル – 階層化](exporting-scenes.resources/exportLayered.png "書き出されたシーンファイル – 階層化"){zoomable="yes"}
