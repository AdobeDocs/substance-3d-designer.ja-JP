...
関数グラフを使用する場合、[変数](../../function-graphs/nodes-reference-for-fun/atomic-function-nodes/get-nodes/get-nodes.md)がグラフ内に存在するかどうかを確認する必要が生じることがあります。
...
* [NewGraph]新しいグラフウィンドウのリワーク
* [NewGraph] マテリアルサンプルと高度なサンプルを追加する
* [新規グラフ]テンプレートデータのグラフに新しい属性（categoryとsubtitle）を追加します
* [NewGraph]出力形式オプションの削除
* [コンテンツ]ハッシュ関数を追加する
* [コンテンツ] functions.sbsにトネマッパーを追加する
* [コンテンツ]異方性反射ノイズ v2:デフォルトの出力フォーマットを追加、無秩序を追加
* [コンテンツ]ノードラベルとパラメータラベルに文頭のみ大文字を適用する
* [コンテンツ] BnWスポット1 v2:デフォルトの出力フォーマットを追加、タイリングをサポートしない
* [コンテンツ] BnWスポット2 v2:デフォルトの出力フォーマットを追加、タイリングをサポートしない
* [コンテンツ] BnWスポット3 v2:デフォルトの出力フォーマットを追加、タイリングをサポートしない
* [コンテンツ] セル 1、2、3、4 v2：デフォルトの出力フォーマットを追加、タイリングのサポートなし、disorder options
* [コンテンツ] Clouds 1 v2:デフォルトの出力フォーマットを追加します。タイリングはサポートされていません。
* [コンテンツ] Clouds 2 v2:デフォルトの出力フォーマットを追加します。タイリングはサポートされていません。
* [コンテンツ] Clouds 3 v2:デフォルトの出力フォーマットを追加します。タイリングはサポートされていません。
* [コンテンツ] v2をマスクするカラー
* [コンテンツ] 方向性ノイズ 1 v2:デフォルトの出力フォーマットを追加します。タイリングはサポートされません。
