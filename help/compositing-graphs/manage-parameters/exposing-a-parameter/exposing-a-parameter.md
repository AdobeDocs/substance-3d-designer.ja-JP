...
1. ![](../../../assets/image2020-9-17-15-37-7.png)<b> [グラフ入力の編集]</b>を選択します。 これにより、グラフプロパティの関連するエントリに直接アクセスできます
...
問題をリセットして削除するには、修正またはリセットするパラメーターの[関数の編集]ボタンの横にあるドロップダウンボタン![](../../../assets/image2020-9-17-15-35-59.png)をクリックし、![](../../../assets/image2020-9-17-16-56-18.png) <b>リセットを選択します。 </b>表示されていない前の状態に戻ります。これを反映して青の名前が再びグレーになります。

![使用されていない入力パラメーターをクリーニングしています](../../../assets/clean-inputs-2.gif "使用されていない入力パラメーターをクリーニングしています"){width="512px"}

### 未使用入力パラメーターのクリーンアップ

入力パラメーターが分からなくなり、使用されているのが分からなくなった場合は、小さなツールを使用してクリーンアップできます。 入力パラメーターメニューボタン![](../../../assets/image2020-9-17-15-39-7.png)をクリックし、<b>入力を消去</b>を選択します。
