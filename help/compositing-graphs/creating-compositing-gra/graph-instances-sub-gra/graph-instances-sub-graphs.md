...
選択したノードがグラフ内の他のノードに接続されていた場合、それらの接続をサブグラフに引き継ぐには、新しいグラフに[入力](../../../compositing-graphs/nodes-reference-for-com/atomic-nodes/input-color/input-color.md)および[出力](../../../compositing-graphs/nodes-reference-for-com/atomic-nodes/output/output.md)ノードも作成する必要があることに注意してください。
