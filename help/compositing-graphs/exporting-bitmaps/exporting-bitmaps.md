...
![簡易化された文書の書き出し](exporting-bitmaps.resources/exportflow.png "簡易化された文書の書き出し")
...
[グラフビュー](../../interface/the-graph-view/the-graph-view.md)で、[ツール]ボタン![](exporting-bitmaps.resources/image2019-9-17-14-44-17.png)をクリックし、**[出力のエクスポート…]**&#x200B;を選択します
...
![出力ダイアログのエクスポート](exporting-bitmaps.resources/fromgraph-1.png "出力ダイアログのエクスポート")
...
![バッチ書き出し出力ダイアログ](exporting-bitmaps.resources/batch.png "バッチ書き出し出力ダイアログ")
