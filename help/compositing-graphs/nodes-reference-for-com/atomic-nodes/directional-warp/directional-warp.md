...
![原子ノード：方向ワープ](directional-warp.resources/directional-warp-01.png "原子ノード：方向ワープ"){width="200px"}
...
![方向ワープ – 例1](directional-warp.resources/directional-warp-02.gif "方向ワープ – 例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![方向ワープ – 例2](directional-warp.resources/directional-warp-03.gif "方向ワープ – 例2"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![方向ワープ – 例3](directional-warp.resources/directional-warp-04.gif "方向ワープ – 例3"){zoomable="yes"}
