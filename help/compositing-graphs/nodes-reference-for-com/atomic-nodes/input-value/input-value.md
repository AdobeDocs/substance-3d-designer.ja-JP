...
breadcrumb-title: ""
description: 入力値ノードを使用して、ユーザーが表示および調整できるSubstanceグラフの値入力パラメーターを作成します。
...
<td style="border: 0; text-align: center" align="center"><img src="input-value.resources/input-value-tooltip.gif" alt="入力値のツールチップ" /></td>
<td style="border: 0; width: 15%" width="15%"></td>
</tr>
</table>
...
![グラフの主な入力](input-value.resources/node-primary-input.png)
