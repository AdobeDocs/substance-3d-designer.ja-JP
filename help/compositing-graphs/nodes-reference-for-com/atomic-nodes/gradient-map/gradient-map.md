...
![原子ノード：グラデーションマップ](gradient-map.resources/gradient-map-01.png "原子ノード：グラデーションマップ"){width="200px"}
...
![グラデーションエディター](gradient-map.resources/gradient-map-02.png "グラデーションエディター")
...
![グラデーションエディター – グラデーション表示](gradient-map.resources/gradient-map-03.png "グラデーションエディター – グラデーション表示")
...
![グラデーションエディター – ピンを追加](gradient-map.resources/gradient-map-04.gif "グラデーションエディター – ピンを追加")
...
![グラデーションエディター – ピンの位置パラメーター](gradient-map.resources/gradient-map-05.png "グラデーションエディター – ピンの位置パラメーター")

</td>
<td style="border: 0;" valign="top">

![グラデーションエディター – ピンを移動](gradient-map.resources/gradient-map-06.gif "グラデーションエディター – ピンを移動")
...
![グラデーションエディター – ピンを削除](gradient-map.resources/gradient-map-07.gif "グラデーションエディター – ピンを削除")
...
![グラデーションエディター：位置を反転](gradient-map.resources/gradient-map-08.gif "グラデーションエディター：位置を反転")
...
![グラデーションエディター – すべてを消去](gradient-map.resources/gradient-map-09.gif "グラデーションエディター – すべてを消去")
...
![グラデーションエディター – カラーピッカー](gradient-map.resources/gradient-map-10.png "グラデーションエディター – カラーピッカー")
...
* <b>グラデーションと色相バー</b>
  ...
  ![カラーピッカー – グラデーション領域と色相バー](gradient-map.resources/gradient-map-11.gif "カラーピッカー – グラデーション領域と色相バー")
...
* <b>RGB、HSV、Alphaのスライダー</b>
  ...
  ![カラーピッカー – RGB、HSV、Alphaスライダー](gradient-map.resources/gradient-map-12.png "カラーピッカー – RGB、HSV、Alphaスライダー")
...
* <b>画面で選択</b>
  ...
  ![カラーピッカー – 画面で選択](gradient-map.resources/gradient-map-13.gif "カラーピッカー – 画面で選択")
...
![カラーピッカー – カラーを元に戻す](gradient-map.resources/gradient-map-14.png "カラーピッカー – カラーを元に戻す")
...
![カラーピッカー – ボタン](gradient-map.resources/gradient-map-15.gif "カラーピッカー – ボタン")
...
![グラデーションエディター – グラデーションピッカー](gradient-map.resources/gradient-map-16.gif "グラデーションエディター – グラデーションピッカー")
