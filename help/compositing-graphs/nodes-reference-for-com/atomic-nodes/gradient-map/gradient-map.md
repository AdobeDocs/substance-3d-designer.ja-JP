...
![アトミックノード:グラデーションマップ](../../../../assets/comp_gradient_1.png "アトミックノード:グラデーションマップ"){width="200px"}
...
![グラデーションエディター](../../../../assets/image2017-2-17-16-13-5.png "グラデーションエディター")
...
![グラデーションエディター – グラデーション表示](../../../../assets/image2017-2-17-17-27-46.png "グラデーションエディター – グラデーション表示")
...
![グラデーションエディター – ピンを追加](../../../../assets/move-pin.gif "グラデーションエディター – ピンを追加")
...
![グラデーションエディター – ピンの位置パラメーター](../../../../assets/image2015-8-27-13-56-2.png "グラデーションエディター – ピンの位置パラメーター")

</td>
<td style="border: 0;" valign="top">

![グラデーションエディター – ピンを移動](../../../../assets/movepin2.gif "グラデーションエディター – ピンを移動")
...
![グラデーションエディター – ピンを削除](../../../../assets/removepin.gif "グラデーションエディター – ピンを削除")
...
![グラデーションエディター：位置を反転](../../../../assets/invert.gif "グラデーションエディター：位置を反転")
...
![グラデーションエディター – すべてを消去](../../../../assets/remove.gif "グラデーションエディター – すべてを消去")
...
![グラデーションエディター – カラーピッカー](../../../../assets/image2017-2-17-18-21-29.png "グラデーションエディター – カラーピッカー")
...
* <b>グラデーションと色相バー</b>
  ...
  ![カラーピッカー – グラデーション領域と色相バー](../../../../assets/colorpalette.gif "カラーピッカー – グラデーション領域と色相バー")
...
* <b>RGB、HSV、Alphaのスライダー</b>
  ...
  ![カラーピッカー – RGB、HSV、Alphaスライダー](../../../../assets/image2017-2-17-18-31-41.png "カラーピッカー – RGB、HSV、Alphaスライダー")
...
* <b>画面で選択</b>
  ...
  ![カラーピッカー – 画面で選択](../../../../assets/pick.gif "カラーピッカー – 画面で選択")
...
![カラーピッカー – カラーを元に戻す](../../../../assets/image2015-8-27-14-40-39.png "カラーピッカー – カラーを元に戻す")
...
![カラーピッカー – ボタン](../../../../assets/invert2.gif "カラーピッカー – ボタン")
...
![グラデーションエディター – グラデーションピッカー](../../../../assets/pickgradient.gif "グラデーションエディター – グラデーションピッカー")
