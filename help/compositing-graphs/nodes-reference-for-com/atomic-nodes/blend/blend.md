...
![原子ノード： Blend](../../../../assets/comp_blend_1.png "原子ノード： Blend"){width="200px"}
...
これは、すべてのAtomicノードの中で最も有用なノードであり、[Substance 3D Designer](https://www.adobe.com/jp/products/substance3d-designer.html)で構築するグラフのほとんどで、このノードが使用されます。
...
>[!TIP]
>
> [この専用ページ](../../../../compositing-graphs/nodes-reference-for-com/atomic-nodes/blend/blending-modes-des/blending-modes-description.md)の描画ノードで使用できる描画モードについて説明します。
