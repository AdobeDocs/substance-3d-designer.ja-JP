...
![アトミックノード: ブレンド](blend.resources/comp_blend_1.png "アトミックノード: ブレンド"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="blend.resources/blend-tooltip.gif" alt="描画ツールヒント" /></div>
