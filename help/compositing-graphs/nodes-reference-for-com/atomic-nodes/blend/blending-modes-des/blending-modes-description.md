...
![描画モード：コピー](blending-modes-description.resources/blending-modes-description-01.png "描画モード：コピー"){zoomable="yes"}

カラー画像の場合、アルファチャンネルは不透明度のデフォルトで考慮されます。

これは、「Alphaブレンド」パラメーターを使用して変更できます。

![描画モード：コピー(2)](blending-modes-description.resources/blending-modes-description-02.png "描画モード：コピー(2)"){zoomable="yes"}

## 追加(覆い焼き（リニア）)

*追加*&#x200B;描画モードでは、前景入力値が背景の対応する各ピクセルに追加されます。

![描画モード：追加(覆い焼き（リニア）](blending-modes-description.resources/blending-modes-description-03.png "描画モード：追加(覆い焼き（リニア）)"){zoomable="yes"}
...
![描画モード：減算](blending-modes-description.resources/blending-modes-description-04.png "描画モード：減算"){zoomable="yes"}
...
![描画モード：乗算](blending-modes-description.resources/blending-modes-description-05.png "描画モード：乗算"){zoomable="yes"}
...
![描画モード：サブを追加](blending-modes-description.resources/blending-modes-description-06.png "描画モード：サブを追加"){zoomable="yes"}

## 最大 (明)

*最大*&#x200B;描画モードでは、背景と前景の間のより高い値が選択されます。

![描画モード：最大（明）](blending-modes-description.resources/blending-modes-description-07.png "描画モード：最大（明）"){zoomable="yes"}

## 最小 (暗)

*分*&#x200B;描画モードでは、背景と前景の間の低い方の値が選択されます。

![描画モード：最小（暗）](blending-modes-description.resources/blending-modes-description-08.png "描画モード：最小（暗）"){zoomable="yes"}
...
![描画モード：スイッチ](blending-modes-description.resources/blending-modes-description-01.png "描画モード：スイッチ"){zoomable="yes"}

## 除算

*除算*&#x200B;描画モードは、背景入力ピクセルの値を前景の対応する各ピクセルで除算します。

![描画モード： 分割](blending-modes-description.resources/blending-modes-description-09.png "描画モード： 分割"){zoomable="yes"}
...
![描画モード：オーバーレイ](blending-modes-description.resources/blending-modes-description-10.png "描画モード：オーバーレイ"){zoomable="yes"}
...
![描画モード：スクリーン](blending-modes-description.resources/blending-modes-description-11.png "描画モード：スクリーン"){zoomable="yes"}
...
![描画モード： ソフトライト](blending-modes-description.resources/blending-modes-description-12.png "描画モード： ソフトライト"){zoomable="yes"}
