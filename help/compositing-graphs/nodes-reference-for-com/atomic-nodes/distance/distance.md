...
![原子ノード：距離](distance.resources/distance-01.png "原子ノード：距離"){width="200px"}
...
| <b>距離モード</b> *整数* | 抽出されたマスクの最も近い境界までの距離を計算する方法を選択します。<ul data-preserve-html="true"> <li data-preserve-html="true"><i>ユークリッド：</i>X/Y差の平方和。</li> <li data-preserve-html="true"><i>マンハッタン：</i> X/Y差の絶対値の合計です。</li> <li data-preserve-html="true"><i>Chebyshev:</i> X/Y差の絶対値の最大値です。</li> </ul>  <div><img alt="距離モードの例" class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_table_copy_copy_copy_row-yj03rtt-column-0i13nfd_image" src="distance.resources/distance-02.jpg" title="距離モードの例"/></div> |
