...
![アトミックノード：距離](distance.resources/comp_distance_1.png "アトミックノード：距離"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="distance.resources/distance-tooltip.gif" alt="距離ツールチップ" /></div>
