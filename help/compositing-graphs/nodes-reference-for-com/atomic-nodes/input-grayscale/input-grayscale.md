...
![アトミックノード：入力グレースケール](input-grayscale.resources/comp_inputgrayscale_1.png "アトミックノード：入力グレースケール"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input-grayscale.resources/input-grayscale-tooltip.gif" alt="グレースケールツールヒントを入力" /></div>
...
![グラフの主な入力](input-grayscale.resources/node-primary-input.png){width="20%"}
