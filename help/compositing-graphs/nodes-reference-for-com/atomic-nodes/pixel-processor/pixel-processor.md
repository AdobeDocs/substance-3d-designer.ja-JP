...
![Atomicノード：ピクセルプロセッサ](pixel-processor.resources/comp_pixelprocessor_1.png "Atomicノード：ピクセルプロセッサ"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="pixel-processor.resources/pixel-processor-tooltip.gif" alt="ピクセルプロセッサツールチップ" /></div>
