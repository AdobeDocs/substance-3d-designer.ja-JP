...
![Atomicノード： Text](text.resources/comp_text_1.png "Atomicノード： Text")
...
<div data-preserve-html="true" style="text-align: center;"><img src="text.resources/text-tooltip.gif" alt="テキストツールヒント" /></div>
