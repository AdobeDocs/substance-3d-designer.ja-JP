...
![Atomicノード：エンボス](emboss.resources/comp_emboss_1.png "Atomicノード：エンボス"){width="100%"}
...
<td style="border: 0; text-align: center"><img src="emboss.resources/emboss-tooltip.gif" alt="エンボスツールチップ" /></td>
<td style="border: 0; width: 15%"></td>
</tr>
</table>
