...
![原子ノード： Output](output.resources/output-01.png "原子ノード： Output"){width="200px"}
...
<table>
  <tr style="border: 0">
    <td style="border: 0">
      <img src="output.resources/output-02.png" alt="defaultupput2">
      <br><i>前</i>
    </td>
    <td style="border: 0">
      <img src="output.resources/output-03.png" alt="defaultupput1">
      <br><i>後</i>
    </td>
  </tr>
</table>
