...
![原子ノード：入力色](input-color.resources/comp_inputcolor_1.png "原子ノード：入力色"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input-color.resources/input-color-tooltip.gif" alt="入力カラーツールチップ" /></div>
...
![グラフの主な入力](input-color.resources/node-primary-input.png){width="20%"}
