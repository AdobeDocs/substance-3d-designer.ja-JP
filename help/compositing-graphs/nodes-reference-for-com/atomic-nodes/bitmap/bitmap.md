...
![アトミックノード:ビットマップ](bitmap.resources/comp_bitmap.png "アトミックノード:ビットマップ"){width="200px"}
...
このノードは、[ビットマップ](../../../../glossary/glossary.md)をグラフに読み込むか、[ビットマップペイントツール](../../../../resources/bitmap-resource/bitmap-painting-tools/bitmap-painting-tools.md)で使用する新しいビットマップを作成するために使用されます。
...
>[!TIP]
>
> 生成または読み込まれた8ビットビットマップは、[2D ビュー](../../../../interface/2d-view/2d-view.md)ドックの[ビットマップペイントツール](../../../../resources/bitmap-resource/bitmap-painting-tools/bitmap-painting-tools.md)を使用してペイントできます。
