...
![アトミックノード：チャンネルの移動](channel-shuffle.resources/comp_shuffle.png "アトミックノード：チャンネルの移動"){width="100%"}
...
<td style="border: 0; text-align: center"><img src="channel-shuffle.resources/channels-shuffle-tooltip.gif" alt="チャンネルシャッフルツールヒント" /></td>
<td style="border: 0; width: 15%"></td>
</tr>
</table>
