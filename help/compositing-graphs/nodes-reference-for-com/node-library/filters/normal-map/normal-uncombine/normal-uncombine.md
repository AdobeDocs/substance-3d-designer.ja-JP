...
|  |  |
| --- | --- |
| <b>標準の形式</b> *整数* | 入力法線マップの形式。 グリーンチャンネルを効果的に反転します。<ul data-preserve-html="true"> <li data-preserve-html="true"><b>DirectX:</b> Y軸が上を指しています</li> <li data-preserve-html="true"><b>OpenGL:</b> Y軸が下を指しています</li> </ul> |
