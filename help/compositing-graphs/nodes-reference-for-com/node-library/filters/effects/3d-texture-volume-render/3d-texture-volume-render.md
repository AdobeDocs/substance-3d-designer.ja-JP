...
| <b>吸収</b> <i>浮動小数</i> | ボリュームの<i>を通過</i>する際に吸収される光の量を調整します。 |
| <b>ぼかし</b> <i>浮動小数</i> | <b>Density</b>入力で指定された値と<i>inner</i>距離フィールド値を乗算します。<br>これにより、ボリュームの外側の境界から内側に<i>フェードグラデーション</i>の幅が効果的に調整されます。 |
...
| <b>光温度（ケルビン）</b> <i>浮動小数</i> | 指向性ライトの温度。これは<i>色</i>に影響します。 <i>低い</i>値を指定すると、<i>暖色</i>の色になります。<br>有用な値：<br>1800 K – キャンドルライト<br>2800 K – 白熱球<br>5500 K – 自然光<br>6200 K – 自然白<br>7000 K – 曇り空<br><i>注意</i>：このパラメーターは、<b>ライトカラーモード</b>パラメーターが<i>温度（ケルビン）</i>に設定されている場合にのみ使用できます。 |
