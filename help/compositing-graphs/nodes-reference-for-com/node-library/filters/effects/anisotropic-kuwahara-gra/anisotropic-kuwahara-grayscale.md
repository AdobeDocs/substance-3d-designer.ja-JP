---
helpx_url: "https://helpx.adobe.com/jp/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/filters/effects/anisotropic-kuwahara-grayscale.html"
breadcrumb-title: ''
...
|  |  |
| --- | --- |
| <b>入力</b> *グレースケール* <b>プライマリ</b> | 処理されるグレースケールイメージです。 |
...
|  |  |
| --- | --- |
| <b>出力</b> *グレースケール* | 入力イメージ上のノードによって適用された異方性ブラーの結果。 |
