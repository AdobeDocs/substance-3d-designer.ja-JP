...
![異方性桑原カラーアイコン](anisotropic-kuwahara.resources/anisotropic_kuwahara_color.png "異方性桑原カラーアイコン"){width="200px"}
...
関連項目： [異方性桑原グレースケール](../anisotropic-kuwahara-gra/anisotropic-kuwahara-grayscale.md)
...
![桑原フィルターを0の異方性で適用した果物のボウル。](anisotropic-kuwahara.resources/anisotropic_kuwahara_color_example_3_before.jpg){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![桑原フィルターを0の異方性で適用した果物のボウル。](anisotropic-kuwahara.resources/anisotropic_kuwahara_color_example_3_after.jpg){zoomable="yes"}
...
|                                                   |                                                                                                                                                                                                                                                                                                                         |
|---------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <b>入力</b> <i>カラー</i><br><code>プライマリ</code> | 処理するカラー画像。 |
...
|                                   |                                                                                                                                                                                                                                      |
|-----------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <b>出力</b> <i>色</i> | 入力イメージ上のノードによって適用された異方性ブラーの結果。 |
...
| <b>アルファを無視</b> <i>ブール値</i> | 「True」の場合、画像のアルファチャンネルはフィルターの影響を受けません。   「False」の場合、フィルターはアルファチャンネルにも適用されます。 |
