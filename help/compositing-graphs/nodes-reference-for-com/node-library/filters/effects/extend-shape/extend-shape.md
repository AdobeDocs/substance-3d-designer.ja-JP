---
helpx_url: "https://helpx.adobe.com/jp/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/filters/effects/extend-shape.html"
breadcrumb-title: ''
...
| <b>延長の距離</b> <i>フロート</i> | <b>延長位置</b>と<b>延長角度</b>で指定されたセクションを延長する距離です。 距離は、画像スパンの<i>比率</i>で表されます。 |
| <b>内線位置</b> <i>フロート</i> | 拡張するセクションのイメージ内の位置です。 値は、中心からの<i>オフセット</i>として表されます。 |
| <b>拡張角度</b> <i>フロート</i> | 開始点を考慮して拡張する必要があるセクションの角度は、<i>垂直セクション</i>です。 |
| <b>開始位置</b> <i>浮動小数点2</i> | <i>拡張ベクター</i>の開始位置です。 |
