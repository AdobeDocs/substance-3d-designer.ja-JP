...
他の2D画像編集アプリケーションで使い慣れている、白黒マスク（グレースケール版の場合）またはアルファチャンネル付きシェイプ（カラー版の場合）の周囲に、線やアウトラインを追加します。 [エッジ検出](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/filters/effects/edge-detect/edge-detect.md)のより完全なバージョンと見なすことができます。
