...
| <b>アルベド</b> <i>浮動小数点3</i> | 図形のサーフェスのアルベド色です。 |
...
| <b>背景色</b> <i>浮動小数点4</i> | レンダリングされたシーンの背景を均一に塗りつぶすために使用される色です。<br><i>注意</i>：このパラメーターは、<b>背景モード</b>パラメーターが<i>均一カラー</i>に設定されている場合にのみ使用できます。 |
| <b>グリッドを有効にする</b> <i>ブール値</i> | <i>真</i>の場合、はグリッドをレンダリングします。 図形を囲む<i>単位立方体</i>はこの平面上にあります。 |
