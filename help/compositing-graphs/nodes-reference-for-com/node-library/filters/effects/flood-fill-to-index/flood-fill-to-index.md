...
さらに、インデックスへのFlood Fillは、新しい[Valueシステムを使用して、見つかった図形の量とオプションの内部データテーブルを含む余分な値](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/values-in-substance-3d-graphs-180192235.html)を返します。
