...
breadcrumb-title: ''
description: 「自動レベル補正」ノードを使用すると、明るさとコントラストの配分が最適になるようにテクスチャレベルが自動調整されます。
...
入力のレベルが自動的に調整され、黒から白までの全範囲が使用されます。 つまり、画像の最も暗い値は完全な黒に調整され、最も明るい値は完全な白に調整されて、コントラストが最大化されます。
