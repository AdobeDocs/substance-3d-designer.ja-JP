...
![マスクの色 – アイコン](color-to-mask.resources/color-to-mask-01.png "マスクの色 – アイコン"){width="200px"}
...
|  |  |
|:---|:---|
| <b>入力</b> <i>色</i> | マスクがカラーに基づいて抽出される入力カラー画像。 |
| <b>カラー入力</b> <i>色</i>   *[色の入力を使用]が&#39;True&#39;に設定されている場合に使用できます* | ピクセルごとの参照カラーの定義に使用する入力カラー画像。 |
...
|  |  |
|:---|:---|
| <b>出力</b> <i>グレースケール</i> | 生成されたマスクはグレースケールビットマップです。 |
