...
![色の量子化アイコン](apply-color-palette.resources/apply-color-palette-01.png "色の量子化アイコン"){width="200px"}
...
![カラーパレットの適用：例1](apply-color-palette.resources/apply-color-palette-02.png "カラーパレットの適用：例1"){zoomable="yes"}
...
![カラーパレットの適用：例3](apply-color-palette.resources/apply-color-palette-05.png "カラーパレットの適用：例3"){zoomable="yes"}
