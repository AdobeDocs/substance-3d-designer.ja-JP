...
![色の量子化アイコン](modify-color-palette.resources/modify-color-palette-01.png "色の量子化アイコン"){width="200px"}
...
![カラーパレットの変更：例1](modify-color-palette.resources/modify-color-palette-02.png "カラーパレットの変更：例1"){zoomable="yes"}

![カラーパレットの変更：例2](modify-color-palette.resources/modify-color-palette-03.png "カラーパレットの変更：例2"){zoomable="yes"}
