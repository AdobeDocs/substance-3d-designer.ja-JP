...
![色の量子化アイコン](modify-color-palette.resources/ModifyColorPalette.png "色の量子化アイコン"){width="200px"}
...
![カラーパレットの変更：例1](modify-color-palette.resources/modify_color_palette_example_1.png "カラーパレットの変更：例1"){zoomable="yes"}

![カラーパレットの変更：例2](modify-color-palette.resources/modify_color_palette_example_3.png "カラーパレットの変更：例2"){zoomable="yes"}
