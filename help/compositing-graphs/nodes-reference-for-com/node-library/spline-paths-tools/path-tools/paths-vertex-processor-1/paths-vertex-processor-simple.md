...
![ノードアイコン](paths-vertex-processor-simple.resources/paths-vertex-processor-simple-icon.png "ノードアイコン")
...
![ノードの例2](paths-vertex-processor-simple.resources/PathsVertexProcessor-Demo2.gif "ノードの例2")
