...
![ノードアイコン](paths-vertex-processor.resources/paths-vertex-processor-icon.png "ノードアイコン")
...
![ノードの例2](paths-vertex-processor.resources/PathsVertexProcessor-Demo2.gif "ノードの例2")
