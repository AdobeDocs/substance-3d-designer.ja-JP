...
| <b>最初のパターンを上書き</b> <i>ブーリアン</i> | 各スプラインの始点に配置するパターンのインデックスを手動で選択します。 |
| <b>最初のパターン入力インデックス</b> <i>整数</i> （&#39;最初のパターンを上書き&#39;が&#39;True&#39;に設定されている場合に使用できます） | 各スプラインの始点に配置するパターンのインデックス。 |
| <b>最後のパターンを上書き</b> <i>ブーリアン</i> | 各スプラインの終端に配置するパターンのインデックスを手動で選択します。 |
...
| <b>減衰の開始/終了</b> <i>浮動小数2</i> | パターンを尺度変更するときの、スプラインの中点からその始点および終点までの距離の係数。<br>これは、スプラインの端に近いパターンのサイズが小さくなることを意味します。 |
| <b>位置</b> |  |
