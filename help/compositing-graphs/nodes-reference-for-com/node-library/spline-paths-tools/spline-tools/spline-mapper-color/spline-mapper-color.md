...
| <b>UVの自動スケール</b> <i>ブーリアン</i> | 座標のスケールを自動的に調整し、スプラインに沿ってマッピングするときに正方形のイメージを保持します。 |
| <b>UV スケール</b> <i>浮動小数2</i> | マップされた座標のスケールをX （水平方向）およびY （垂直方向）で調整します。<br>値を大きくすると、画像のタイル密度が高くなります。 |
...
| <b>開始</b> <i>浮動小数</i> | マッピングするスプラインの部分の始点をオフセットします。<br>この値は、スプラインの正規化された長さを表します。 |
| <b>終了</b> <i>浮動小数</i> | マッピングするスプライン部分の終点をオフセットします。<br>この値は、スプラインの正規化された長さを表します。 |
