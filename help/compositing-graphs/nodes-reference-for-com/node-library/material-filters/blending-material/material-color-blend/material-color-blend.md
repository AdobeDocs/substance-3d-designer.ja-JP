...
| <b>基本色</b> | このチャンネルの上に単色をブレンド付けします。Diffuseグループ内のオプションも使用できます。 |
| <b>標準</b> |  |
...
| <b>Specular</b> | このチャンネルの上に単色をブレンド付けします。Diffuseグループ内のオプションも使用できます。 |
| <b>Emissive</b> | このチャンネルの上に単色をブレンド付けします。Diffuseグループ内のオプションも使用できます。 |
| <b>光沢度</b> | このチャンネルの上に単色をブレンド付けします。Diffuseグループ内のオプションも使用できます。 |
| <b>ラフネス</b> | このチャンネルの上に単色をブレンド付けします。Diffuseグループ内のオプションも使用できます。 |
| <b>メタリック</b> | このチャンネルの上に単色をブレンド付けします。Diffuseグループ内のオプションも使用できます。 |
| <b>Specular level</b> | このチャンネルの上に単色をブレンド付けします。Diffuseグループ内のオプションも使用できます。 |
| <b>Ambient occlusion</b> | このチャンネルの上に単色をブレンド付けします。Diffuseグループ内のオプションも使用できます。 |
| <b>Height</b> | このチャンネルの上に単色をブレンド付けします。Diffuseグループ内のオプションも使用できます。 |
| <b>不透明度</b> | このチャンネルの上に単色をブレンド付けします。Diffuseグループ内のオプションも使用できます。 |
