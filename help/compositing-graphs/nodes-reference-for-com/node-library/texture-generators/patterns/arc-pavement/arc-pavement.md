...
* **スケール**: *1 ～ 8*&#x200B;グローバルスケール/タイリングを設定します。
* **パターン適用量**: *1 -* 32\
  すべての円弧で使用するレンガの量を設定します。
* **パターン適用量ランダム**: *0.0 - 1.0*\
  各弧のレンガの量をランダムに変化させます。 レンガに様々なスケールを設定する効果もあります。
* **パターンの最小量**: *1 - 10*\
  円弧をランダム化するときのレンガの最小量をコントロールします。
* **円弧の量**: *0 - 20*\
  上下に積み重ねる円弧の数を設定します。 Heightを変更します。
* **パターン**: *入力画像、正方形、円盤、放物面、ベル、ガウス、とげ、ピラミッド、レンガ、グラデーション、波、ハーフベル、うね付きベル、三日月、カプセル、円錐*\
  使用するパターン形状を選択します。
* **フィルタリング**: *バイリニア+ミップマップ，バイリニア，最も近い*
