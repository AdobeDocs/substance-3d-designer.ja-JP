...
| <b>ベクトルマップディスプレイスメント</b> *フロート* | <b>ベクトルマップ</b>入力の&#x200B;*サンプリングされた*&#x200B;値を使用して、各頂点に適用される&#x200B;*グローバル*&#x200B;ディスプレイスメント量を調整します。   このオフセット&#x200B;*スタック*&#x200B;は、<b>ランダムな位置</b>および<b>クインキュックスのオフセット</b>のパラメーターを使用します。 |
...
| <b>クインキュックスのオフセットY</b> *フロート* | 指定したオフセット量を、グリッド内の&#x200B;*セルのサイズ*&#x200B;を基準として、頂点の&#x200B;*列おきに*&#x200B;適用します。   このオフセット&#x200B;*スタック*&#x200B;は、<b>ランダムな位置</b>と<b>ベクトルマップディスプレイスメント</b>のパラメーターを使用します。 |
| <b>回転</b> *フロート* | *指定*&#x200B;の回転量を、各頂点の&#x200B;*基本位置*&#x200B;の周りに適用します。つまり、各頂点の位置&#x200B;*前*&#x200B;のランダムオフセットとディスプレイスメントが適用されます。   この回転&#x200B;*スタック*&#x200B;は、<b>回転障害</b>パラメーターを使用します。 |
