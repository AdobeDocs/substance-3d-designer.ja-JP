...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="3d-ridged-noise-fractal.resources/3dridgednoisefractal-variant.jpg" class="modal-image" alt="3D浮彫りノイズフラクタル – 例1" />
        </td>
        <td style="border: 0;">
            <img src="3d-ridged-noise-fractal.resources/3dridgednoisefractal-variant2.jpg" class="modal-image" alt="3D浮彫りノイズフラクタル – 例2" />
        </td>
