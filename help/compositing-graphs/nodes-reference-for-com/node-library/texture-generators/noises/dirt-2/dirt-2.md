---
helpx_url: "https://helpx.adobe.com/jp/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/dirt-2.html"
breadcrumb-title: ""
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="dirt-2.resources/dirt_2_1.png" class="modal-image" alt="Dirt 2 – 例1" />
        </td>
        <td style="border: 0;">
            <img src="dirt-2.resources/noise_dirt_2_v2_speed0.6_aniso0.gif" class="modal-image" alt="Dirt 2 – 例2" />
        </td>
        <td style="border: 0;">
            <img src="dirt-2.resources/noise_dirt_2_v2_speed0.6_aniso1.gif" class="modal-image" alt="Dirt 2 – 例3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="dirt-2.resources/noise_dirt_2_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="Dirt 2 – 例4" />
        </td>
