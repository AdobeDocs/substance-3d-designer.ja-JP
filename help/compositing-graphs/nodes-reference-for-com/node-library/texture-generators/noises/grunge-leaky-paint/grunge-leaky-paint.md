...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-leaky-paint.resources/grungeleakypaint-variant.jpg" class="modal-image" alt="経年劣化漏えいのペイント – 例1" />
        </td>
        <td style="border: 0;">
            <img src="grunge-leaky-paint.resources/grungeleakypaint-variant2.jpg" class="modal-image" alt="経年劣化漏えいのペイント – 例2" />
        </td>
