...
![方向性ノイズ 3 – アイコン](directional-noise-3.resources/directional-noise-3-01.png "方向性ノイズ 3 – アイコン"){width="200px"}
...
![方向性ノイズ 3 – 例1](directional-noise-3.resources/directional-noise-3-02.png "方向性ノイズ 3 – 例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![方向性ノイズ 3 – 例2](directional-noise-3.resources/directional-noise-3-03.gif "方向性ノイズ 3 – 例2"){zoomable="yes"}
...
![方向性ノイズ 3 – 例3](directional-noise-3.resources/directional-noise-3-04.gif "方向性ノイズ 3 – 例3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![方向性ノイズ 3 – 例4](directional-noise-3.resources/directional-noise-3-05.gif "方向性ノイズ 3 – 例4"){zoomable="yes"}
