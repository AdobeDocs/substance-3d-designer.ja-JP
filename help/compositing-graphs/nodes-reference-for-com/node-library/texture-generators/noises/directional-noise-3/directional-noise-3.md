...
breadcrumb-title: ''
description: '[方向性ノイズ 3]ノードを使用して、3つのオクターブを持つ方向性ノイズパターンを作成し、指向性テクスチャを作成します。'
...
![方向性ノイズ 3 – アイコン](directional-noise-3.resources/directional_noise_3.png "方向性ノイズ 3 – アイコン"){width="200px"}
...
![方向性ノイズ 3 – 例1](directional-noise-3.resources/directional_noise_3_1.png "方向性ノイズ 3 – 例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![方向性ノイズ 3 – 例2](directional-noise-3.resources/noise_directional_noise_3_v2_speed0.6_aniso0.gif "方向性ノイズ 3 – 例2"){zoomable="yes"}
...
![方向性ノイズ 3 – 例3](directional-noise-3.resources/noise_directional_noise_3_v2_speed0.6_aniso1.gif "方向性ノイズ 3 – 例3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![方向性ノイズ 3 – 例4](directional-noise-3.resources/noise_directional_noise_3_v2_speed0.3_aniso0.6.gif "方向性ノイズ 3 – 例4"){zoomable="yes"}
