...
![ガウスのスポット2 – アイコン](gaussian-spots-2.resources/gaussian-spots-2-01.png "ガウスのスポット2 – アイコン"){width="200px"}
...
![ガウスのスポット2 – 例1](gaussian-spots-2.resources/gaussian-spots-2-02.png "ガウスのスポット2 – 例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![ガウスのスポット2 – 例2](gaussian-spots-2.resources/gaussian-spots-2-03.gif "ガウスのスポット2 – 例2"){zoomable="yes"}
...
![ガウスのスポット2 – 例3](gaussian-spots-2.resources/gaussian-spots-2-04.gif "ガウスのスポット2 – 例3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![ガウスのスポット2 – 例4](gaussian-spots-2.resources/gaussian-spots-2-05.gif "ガウスのスポット2 – 例4"){zoomable="yes"}
