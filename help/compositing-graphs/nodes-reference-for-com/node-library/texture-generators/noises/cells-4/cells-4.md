...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="cells-4.resources/cells_4_1.png" class="modal-image" alt="セル 4 – 例1" />
        </td>
        <td style="border: 0;">
            <img src="cells-4.resources/noise_cells_4_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="セル 4 – 例2" />
        </td>
