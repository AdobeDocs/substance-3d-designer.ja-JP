...
| <b>グローバル不透明度</b> <i>浮動小数</i> | フラクタルパーリンノイズの値の&#x200B;*範囲*&#x200B;を0から制御します。 |
| <b>角丸曲線</b> <i>浮動小数</i> | ノイズの各点の周りに&#x200B;*勾配*&#x200B;を丸めて&#x200B;*凸型*&#x200B;にします。<br><br>*注意*: **Style**&#x200B;パラメーターが&#x200B;*Edge*&#x200B;に設定されている場合、このパラメーターは使用できません。 |
| <b>距離スケール</b> <i>浮動小数</i> | ノイズの各点の周囲の&#x200B;*グラデーションの距離*&#x200B;を調整します。 |
| <b>距離モード</b> <i>整数</i> | ノイズの各点の周囲の&#x200B;*グラデーションの計算*&#x200B;に設定します：<br><br>- *ユークリッド*<br>- *マンハッタン*<br>- *チェビシェフ*<br>- *ミンコフスキー* |
| <b>ミンコフスキー数</b> <i>浮動小数</i> | ミンコフスキー距離の次数&#x200B;*p*。 距離グラデーションを象限に分割すると、この数は次のように象限に影響します。<br><br>- pは&#x200B;*正確* 1：直線<br>- pは&#x200B;*低* 1より：凹<br>- pは&#x200B;*大* 1より：凸<br><br>対象の値：<br><br>- *1.0*:マンハッタン距離<br>- *2.0*:ユークリッド距離&#x200B;*無限大*:チェビシェフ距離&#x200B;<br><br>*注意*：このパラメーターは、**距離モード**&#x200B;パラメーターが&#x200B;*ミンコフスキー*&#x200B;に設定されている場合にのみ使用できます。<br> |
| <b>ブレンドモード</b> <i>整数</i> | *重なり合うセル*&#x200B;の値を<br><br>- *加算*&#x200B;の間でブレンドする方法を設定します：値の加算<br>- *最大値*: *最大値*&#x200B;の値<br>- *最小値*: *最小値*&#x200B;の値を保持 |
...
| <b>エッジThickness</b> <i>浮動小数</i> | フラクタルボロノイノイズのセル間で検出されるエッジのThicknessを調整します。 X、Y、およびZ軸で辺が検出されました。セルの&#x200B;*深度*&#x200B;によっては、一部の太さが他よりも速く増加する場合があります。<br><br>*注意*：このパラメーターは、**Style**&#x200B;パラメーターが&#x200B;*Edge*&#x200B;に設定されている場合にのみ使用できます。 |
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="voronoi-fractal.resources/fractal-voronoi-sea.gif" class="modal-image" alt="ボロノイフラクタル – 例1" />
        </td>
        <td style="border: 0;">
            <img src="voronoi-fractal.resources/fractal-voronoi-scifi-panel.gif" class="modal-image" alt="ボロノイフラクタル – 例2" />
        </td>
        <td style="border: 0;">
            <img src="voronoi-fractal.resources/voronoifractal-variant.jpg" class="modal-image" alt="ボロノイフラクタル – 例3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="voronoi-fractal.resources/voronoifractal-variant2.jpg" class="modal-image" alt="ボロノイフラクタル – 例4" />
        </td>
        <td style="border: 0;">
            <img src="voronoi-fractal.resources/voronoifractal-variant6.jpg" class="modal-image" alt="ボロノイフラクタル – 例5" />
        </td>
        <td style="border: 0;">
            <img src="voronoi-fractal.resources/voronoifractal-variant3.jpg" class="modal-image" alt="ボロノイフラクタル – 例6" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="voronoi-fractal.resources/voronoifractal-variant5.jpg" class="modal-image" alt="ボロノイフラクタル – 例7" />
        </td>
        <td style="border: 0;">
            <img src="voronoi-fractal.resources/voronoifractal-variant4.jpg" class="modal-image" alt="ボロノイフラクタル – 例8" />
        </td>
