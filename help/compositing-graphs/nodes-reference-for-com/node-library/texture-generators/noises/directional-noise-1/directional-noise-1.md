...
![方向性ノイズ 1 – アイコン](../../../../../../assets/directional_noise_1.png "方向性ノイズ 1 – アイコン"){width="200px"}
...
| <b>角度</b>浮動小数点 | ノイズの向きを指定するために使用する角度を、水平方向の右方向から数ターン単位で指定します。 |
| <b>角度ランダム</b>浮動小数 | <b>角度</b>の値に適用されるランダムな変動の最大量（ターン数）。 |
...
![方向性ノイズ 1 – 例1](../../../../../../assets/directional_noise_1_1.png "方向性ノイズ 1 – 例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![方向性ノイズ 1 – 例2](../../../../../../assets/noise_directional_noise_1_v2_speed0.6_aniso0.gif "方向性ノイズ 1 – 例2"){zoomable="yes"}
...
![方向性ノイズ 1 – 例3](../../../../../../assets/noise_directional_noise_1_v2_speed0.6_aniso1.gif "方向性ノイズ 1 – 例3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![方向性ノイズ 1 – 例4](../../../../../../assets/noise_directional_noise_1_v2_speed0.3_aniso0.6.gif "方向性ノイズ 1 – 例4"){zoomable="yes"}
