...
| <b>ゆがみの適用度</b> <i>フロート</i> | フラクタル3Dボロノイノイズに適用される<i>ワープ効果</i>の強度を制御します。 |
...
| <b>粗さ</b> <i>フロート</i> | フラクタルパターンでの<i>バランス</i>の低い繰り返しと高い繰り返し<i>レベル</i>を制御します。<br><br><i>注意</i>: <b>0</b>の値を指定すると、<i>行にない</i>出力で、その後に他の低い値が続きます。 これは予期される動作です。<br><br><i>注意2</i>：このパラメーターは、<b>描画モード</b>パラメーターが<i>追加</i>に設定されている場合にのみ使用できます。 |
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="3d-voronoi-fractal.resources/3dvoronoifractal-variant6.jpg" class="modal-image" alt="3D Voronoi Fractal – 例1" />
        </td>
        <td style="border: 0;">
            <img src="3d-voronoi-fractal.resources/3dvoronoifractal-variant2.jpg" class="modal-image" alt="3D Voronoi Fractal – 例2" />
        </td>
        <td style="border: 0;">
            <img src="3d-voronoi-fractal.resources/3dvoronoifractal-variant4.jpg" class="modal-image" alt="3D Voronoi Fractal – 例3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="3d-voronoi-fractal.resources/3dvoronoifractal-variant5.jpg" class="modal-image" alt="3D Voronoi Fractal – 例4" />
        </td>
        <td style="border: 0;">
            <img src="3d-voronoi-fractal.resources/3dvoronoifractal-variant.jpg" class="modal-image" alt="3D Voronoi Fractal – 例5" />
        </td>
        <td style="border: 0;">
            <img src="3d-voronoi-fractal.resources/3dvoronoifractal-variant3.jpg" class="modal-image" alt="3D Voronoi Fractal – 例6" />
        </td>
    </tr>
</table>
