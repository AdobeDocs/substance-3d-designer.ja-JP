...
[Substance 3D Designer](https://www.adobe.com/jp/products/substance3d-designer.html)の&#x200B;**経年劣化削り**&#x200B;ノードは、表面に散らばった削り屑に似た経年劣化マップを生成します。
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-shavings.resources/grungeshavings-variant2.jpg" class="modal-image" alt="経年劣化削り – 例1" />
        </td>
        <td style="border: 0;">
            <img src="grunge-shavings.resources/grungeshavings-variant.jpg" class="modal-image" alt="経年劣化削り – 例2" />
        </td>
