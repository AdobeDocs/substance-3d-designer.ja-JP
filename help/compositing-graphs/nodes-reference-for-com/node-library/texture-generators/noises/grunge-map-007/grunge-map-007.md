---
helpx_url: "https://helpx.adobe.com/jp/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/grunge-map-007.html"
breadcrumb-title: ""
description: '[経年劣化マップ007]ノードを使用して、サーフェスの変動と摩耗効果を加えるためのプロシージャルの経年劣化テクスチャを作成します。'
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-map-007.resources/grungemap-007-ex.gif" class="modal-image" alt="経年劣化マップ007 – 例1" />
        </td>
