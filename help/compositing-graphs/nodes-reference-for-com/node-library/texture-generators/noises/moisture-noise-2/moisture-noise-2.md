...
breadcrumb-title: ''
description: '[モイスチャノイズ 2]ノードを使用して、リアルなサーフェステクスチャ用に有機的なモイスチャパターンを作成します。'
...
![水分ノイズ 2 – アイコン](../../../../../../assets/moisture_noise_2.png "水分ノイズ 2 – アイコン"){width="200px"}
...
参照： [水分ノイズ1](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/texture-generators/noises/moisture-noise/moisture-noise.md)
