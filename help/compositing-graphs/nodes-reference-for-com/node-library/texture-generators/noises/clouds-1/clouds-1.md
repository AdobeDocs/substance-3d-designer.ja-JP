...
breadcrumb-title: ""
description: 大気テクスチャエフェクトおよびボリュームテクスチャエフェクトを作成するための基本的な雲のパターンを生成するには、 Clouds 1ノードを使用します。
...
![雲1 – アイコン](clouds-1.resources/clouds_1.png "雲1 – アイコン"){width="200px"}
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="clouds-1.resources/clouds_1_1.png" class="modal-image" alt="雲1 – 例1" />
        </td>
        <td style="border: 0;">
            <img src="clouds-1.resources/noise_clouds_1_v2_speed0.6_aniso0.gif" class="modal-image" alt="雲1 – 例2" />
        </td>
        <td style="border: 0;">
            <img src="clouds-1.resources/noise_clouds_1_v2_speed0.6_aniso1.gif" class="modal-image" alt="雲1 – 例3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="clouds-1.resources/noise_clouds_1_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="雲1 – 例4" />
        </td>
