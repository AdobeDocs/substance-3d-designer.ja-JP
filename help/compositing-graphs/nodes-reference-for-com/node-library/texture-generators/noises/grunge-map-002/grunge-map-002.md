...
breadcrumb-title: ""
description: 経年劣化マップ002ノードを使用して、風化および経年変化したマテリアルサーフェスを作成するためのプロシージャル経年劣化パターンを作成します。
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-map-002.resources/grungemap-002-ex.gif" class="modal-image" alt="経年劣化マップ002 – 例1" />
        </td>
