---
helpx_url: "https://helpx.adobe.com/jp/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/grunge-map-004.html"
breadcrumb-title: ""
description: 経年劣化マップ004ノードを使用して、風化および劣化したテクスチャ効果を加えるためのプロシージャル経年劣化パターンを作成します。
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-map-004.resources/grungemap-004-ex.gif" class="modal-image" alt="経年劣化マップ004 – 例1" />
        </td>
