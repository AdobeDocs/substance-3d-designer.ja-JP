...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="3d-worley-noise.resources/3d-worley-ex04.png" class="modal-image" alt="3D Worleyノイズ – 例1" />
        </td>
        <td style="border: 0;">
            <img src="3d-worley-noise.resources/3d-worley-ex03.png" class="modal-image" alt="3D Worleyノイズ – 例2" />
        </td>
        <td style="border: 0;">
            <img src="3d-worley-noise.resources/3d-worley-ex02.png" class="modal-image" alt="3D Worleyノイズ – 例3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="3d-worley-noise.resources/3d-worley-ex01.png" class="modal-image" alt="3D Worleyノイズ – 例4" />
        </td>
