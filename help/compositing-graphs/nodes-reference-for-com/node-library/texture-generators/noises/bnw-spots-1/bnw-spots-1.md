...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="bnw-spots-1.resources/bnw_spots_1_1.png" class="modal-image" alt="BnWスポット1 – 例1" />
        </td>
        <td style="border: 0;">
            <img src="bnw-spots-1.resources/noise_bnw_spots_1_v2_speed0.6_aniso0.gif" class="modal-image" alt="BnWスポット1 – 例2" />
        </td>
        <td style="border: 0;">
            <img src="bnw-spots-1.resources/noise_bnw_spots_1_v2_speed0.6_aniso1.gif" class="modal-image" alt="BnWスポット1 – 例3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="bnw-spots-1.resources/noise_bnw_spots_1_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="BnWスポット1 – 例4" />
        </td>
