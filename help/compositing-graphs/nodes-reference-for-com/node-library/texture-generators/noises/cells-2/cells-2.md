...
| <b>エッジの幅</b> <i>浮動小数</i> | セル間の壁のThicknessを、グリッドの比率で補正します。 （解像度に依存しない） |
| <b>反転</b> <i>ブーリアン</i> | 出力画像の黒と白を切り替えます。 |
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="cells-2.resources/cells_2_1.png" class="modal-image" alt="セル 2 – 例1" />
        </td>
        <td style="border: 0;">
            <img src="cells-2.resources/noise_cells_2_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="セル 2 – 例2" />
        </td>
