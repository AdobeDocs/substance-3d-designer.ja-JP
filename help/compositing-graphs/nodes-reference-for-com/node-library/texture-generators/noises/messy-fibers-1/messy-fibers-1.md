...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="messy-fibers-1.resources/messy_fibers_1_1.png" class="modal-image" alt="乱雑な繊維1 – アイコン" />
        </td>
        <td style="border: 0;">
            <img src="messy-fibers-1.resources/noise_messy_fibers_1_v2_speed0.1_aniso0.gif" class="modal-image" alt="乱雑な繊維1 – 例2" />
        </td>
        <td style="border: 0;">
            <img src="messy-fibers-1.resources/noise_messy_fibers_1_v2_speed0.1_aniso1.gif" class="modal-image" alt="乱雑な繊維1 – 例3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="messy-fibers-1.resources/noise_messy_fibers_1_v2_speed0.1_aniso0.6.gif" class="modal-image" alt="乱雑な繊維1 – 例4" />
        </td>
