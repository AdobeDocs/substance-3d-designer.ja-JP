---
helpx_url: "https://helpx.adobe.com/jp/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/messy-fibers-1.html"
breadcrumb-title: ''
...
![乱雑な繊維1 – アイコン](messy-fibers-1.resources/messy_fibers_1.png "乱雑な繊維1 – アイコン"){width="200px"}
...
| <b>角度</b> <i>浮動小数</i> | ねじの方向の設定に使用する角度です。回転の回数で指定し、横方向右から開始します。 |
| <b>角度ランダム</b> <i>浮動小数</i> | <b>角度</b>の値に適用されるランダムな変動の最大量（ターン数）。 |
| <b>行番号</b> <i>浮動小数</i> | 基本スレッドに適用されるタイリングの量。値が大きいほど、スレッドの密度が高く、細くなります。 |
...
![乱雑な繊維1 – アイコン](messy-fibers-1.resources/messy_fibers_1_1.png "乱雑な繊維1 – アイコン"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![乱雑な繊維1 – 例2](messy-fibers-1.resources/noise_messy_fibers_1_v2_speed0.1_aniso0.gif "乱雑な繊維1 – 例2"){zoomable="yes"}
...
![乱雑な繊維1 – 例3](messy-fibers-1.resources/noise_messy_fibers_1_v2_speed0.1_aniso1.gif "乱雑な繊維1 – 例3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![乱雑な繊維1 – 例4](messy-fibers-1.resources/noise_messy_fibers_1_v2_speed0.1_aniso0.6.gif "乱雑な繊維1 – 例4"){zoomable="yes"}
