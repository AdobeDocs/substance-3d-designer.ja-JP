---
helpx_url: "https://helpx.adobe.com/jp/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/grunge-spots-dirty.html"
breadcrumb-title: ""
description: 「経年劣化スポットのダーティ」ノードを使用して、汚れたスポットパターンを追加し、風化および老朽化したマテリアル効果を生み出します。
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-spots-dirty.resources/grungespotsdirty-variant2.jpg" class="modal-image" alt="経年劣化スポットの汚れ – 例1" />
        </td>
        <td style="border: 0;">
            <img src="grunge-spots-dirty.resources/grungespotsdirty-variant.jpg" class="modal-image" alt="経年劣化スポットの汚れ – 例2" />
        </td>
