...
![フラクタル和 3 – アイコン](fractal-sum-3.resources/fractal-sum-3-01.png "フラクタル和 3 – アイコン"){width="200px"}
...
![フラクタル和 3 – 例1](fractal-sum-3.resources/fractal-sum-3-02.png "フラクタル和 3 – 例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![フラクタル和 3 – 例2](fractal-sum-3.resources/fractal-sum-3-03.gif "フラクタル和 3 – 例2"){zoomable="yes"}
