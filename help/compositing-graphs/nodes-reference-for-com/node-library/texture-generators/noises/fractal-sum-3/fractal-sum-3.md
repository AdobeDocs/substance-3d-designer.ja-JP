...
breadcrumb-title: ''
description: 「フラクタル和 3」ノードを使用して、有機的なテクスチャパターンを作成するための3オクターブのフラクタルノイズを生成します。
...
![フラクタル和 3 – 例1](fractal-sum-3.resources/fractal_sum_3_1.png "フラクタル和 3 – 例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![フラクタル和 3 – 例2](fractal-sum-3.resources/noise_fractal_sum_3_v2_speed0.6_aniso0.gif "フラクタル和 3 – 例2"){zoomable="yes"}
