...
![フラクタル和 1 – アイコン](fractal-sum-1.resources/fractal_sum_1.png "フラクタル和 1 – アイコン"){width="200px"}
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="fractal-sum-1.resources/fractal_sum_1_1.png" class="modal-image" alt="フラクタル和 1 – 例1" />
        </td>
        <td style="border: 0;">
            <img src="fractal-sum-1.resources/noise_fractal_sum_1_v2_speed0.6_aniso0.gif" class="modal-image" alt="フラクタル和 1 – 例2" />
        </td>
