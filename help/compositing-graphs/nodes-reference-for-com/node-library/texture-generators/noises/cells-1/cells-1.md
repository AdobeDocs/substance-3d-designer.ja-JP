...
| <b>パターン</b>の整数 | 生成された画像に散乱したベース形状。 |
| <b>パターンサイズ</b> 浮動小数2 | セル内の散乱パターンのサイズの乗数。1.0はセルの完全なスパンです。 |
| <b>パターンスケール</b>の浮動小数 | <b>パターンサイズ</b>の乗数。1.0は完全なサイズです。 |
| <b>輝度ランダム</b>浮動小数 | セルからランダムに減算した輝度の範囲を指定します。1はセル範囲全体です。 |
| <b>角度</b>の浮動小数 | セルの方向の設定に使用する角度を指定します。この値は、水平方向の右から数えたターン数で指定します。 |
