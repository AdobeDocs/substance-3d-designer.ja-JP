...
![Dirt 5 – アイコン](dirt-5.resources/dirt_5.png "Dirt 5 – アイコン"){width="200px"}
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="dirt-5.resources/dirt_5_1.png" class="modal-image" alt="Dirt 5 – 例1" />
        </td>
        <td style="border: 0;">
            <img src="dirt-5.resources/noise_dirt_5_v2_speed0.6_aniso0.gif" class="modal-image" alt="Dirt 5 – 例2" />
        </td>
        <td style="border: 0;">
            <img src="dirt-5.resources/noise_dirt_5_v2_speed0.6_aniso1.gif" class="modal-image" alt="Dirt 5 – 例3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="dirt-5.resources/noise_dirt_5_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="Dirt 5 – 例4" />
        </td>
