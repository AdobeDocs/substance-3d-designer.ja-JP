---
helpx_url: "https://helpx.adobe.com/jp/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/grunge-map-009.html"
breadcrumb-title: ""
description: 経年劣化マップ009ノードを使用して、サーフェスのディテールおよび磨耗のエフェクトをマテリアルに加えるためのプロシージャル経年劣化 テクスチャを作成します。
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-map-009.resources/grungemap-009-ex.gif" class="modal-image" alt="経年劣化マップ009 – 例1" />
        </td>
