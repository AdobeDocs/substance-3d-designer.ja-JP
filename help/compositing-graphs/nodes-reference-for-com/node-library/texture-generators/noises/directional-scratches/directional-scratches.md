...
| <b>パターン適用量</b>浮動小数 | 散布されるスクラッチパターンの量の乗数。 |
| <b>パターンサイズ</b> 浮動小数2 | スクラッチパターンの境界ボックスのサイズです。    Y値はスクラッチの最大長を制御します。 |
| <b>パターンサイズのランダム</b>浮動小数2 | スクラッチに適用されるダウンスケーリングのランダム量の乗数。    Y値は、スクラッチの長さに適用されます。 |
