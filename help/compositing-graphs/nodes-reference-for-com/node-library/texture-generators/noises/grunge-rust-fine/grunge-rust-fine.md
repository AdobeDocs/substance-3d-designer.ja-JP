...
* アドバンス
  * **ベース経年劣化コントラスト** *浮動小数*&#x200B;錆のベースとして使用する経年劣化テクスチャのコントラストを調整します。
  * **ベースワープの強さ** *浮動小数*&#x200B;錆のベースとして使用される経年劣化マップに適用されるワープ効果の強さを調整します。
  * **筋の強さ** *浮動小数*&#x200B;ベース経年劣化テクスチャに重なる明るい筋とスポットの強さを調整します。
  * **ノイズの強さ** *浮動小数*&#x200B;基本経年劣化のテクスチャに適用されるノイズの強さを調整します。
