...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-rust-fine.resources/grungerustfine-variant2.jpg" class="modal-image" alt="錆罰金 – 例1" />
        </td>
        <td style="border: 0;">
            <img src="grunge-rust-fine.resources/grungerustfine-variant.jpg" class="modal-image" alt="錆罰金 – 例2" />
        </td>
