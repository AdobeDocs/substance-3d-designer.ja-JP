---
helpx_url: "https://helpx.adobe.com/jp/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/bnw-spots-2.html"
breadcrumb-title: ''
description: 「BnWスポット2」ノードを使用して、テクスチャのバリエーションのコントロールを強化した白黒のスポットパターンを作成します。
...
![BnW個のスポット2 – アイコン](bnw-spots-2.resources/bnw_spots_2.png "BnW個のスポット2 – アイコン"){width="200px"}
...
![BnWスポット2 – 例1](bnw-spots-2.resources/bnw_spots_2_1.png "BnWスポット2 – 例1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![BnWスポット2 – 例2](bnw-spots-2.resources/noise_bnw_spots_2_v2_speed0.6_aniso0.gif "BnWスポット2 – 例2"){zoomable="yes"}
...
![BnWスポット2 – 例3](bnw-spots-2.resources/noise_bnw_spots_2_v2_speed0.6_aniso1.gif "BnWスポット2 – 例3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![BnWスポット2 – 例4](bnw-spots-2.resources/noise_bnw_spots_2_v2_speed0.3_aniso0.6.gif "BnWスポット2 – 例4"){zoomable="yes"}
