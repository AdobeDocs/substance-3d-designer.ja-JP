...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="bnw-spots-2.resources/bnw_spots_2_1.png" class="modal-image" alt="BnWスポット2 – 例1" />
        </td>
        <td style="border: 0;">
            <img src="bnw-spots-2.resources/noise_bnw_spots_2_v2_speed0.6_aniso0.gif" class="modal-image" alt="BnWスポット2 – 例2" />
        </td>
        <td style="border: 0;">
            <img src="bnw-spots-2.resources/noise_bnw_spots_2_v2_speed0.6_aniso1.gif" class="modal-image" alt="BnWスポット2 – 例3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="bnw-spots-2.resources/noise_bnw_spots_2_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="BnWスポット2 – 例4" />
        </td>
