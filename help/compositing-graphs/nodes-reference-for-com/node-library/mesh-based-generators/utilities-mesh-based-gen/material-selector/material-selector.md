...
breadcrumb-title: ''
description: マテリアルセレクターノードを使用すると、メッシュデータに基づいてマテリアルを選択し、マルチマテリアルのテクスチャエフェクトを作成できます。
...
フルカラーのID マップを、バイナリ、黒、白のマスクに変換します。 異なるカラーをブレンドして1つのマスクに結合できます。

これは、[マルチブレンド](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/material-filters/blending-material/multi-material-blend/multi-material-blend.md)を使用せずにマスクを手動で使用する場合や、同じマスクを他の場所で手動で使用する場合に便利です。
...
|  |  |
|:---|:---|
| <b>マテリアル</b> <i>1 - 16</i> | 結合を有効にするマテリアルの数を設定します。 |
