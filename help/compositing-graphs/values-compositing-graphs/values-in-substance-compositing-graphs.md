...
![出力値ノード](values-in-substance-compositing-graphs.resources/values-output.gif "出力値ノード"){width="512px"}
...
![ノードに入力値を追加しています](values-in-substance-compositing-graphs.resources/values-inputs.gif "ノードに入力値を追加しています")
...
![値の操作](values-in-substance-compositing-graphs.resources/yellowhighlight.png "値の操作")
