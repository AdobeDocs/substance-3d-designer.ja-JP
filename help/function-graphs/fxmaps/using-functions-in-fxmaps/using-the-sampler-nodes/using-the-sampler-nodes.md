---
helpx_url: "https://helpx.adobe.com/jp/substance-3d-designer/function-graphs/fxmaps/using-functions-in-fxmaps/using-the-sampler-nodes.html"
breadcrumb-title: ''
description: FXMapでsamplerノードを使用してテクスチャをサンプリングし、プロシージャルマテリアルバリエーションを作成する方法について説明します。
...
この例では、パターンのグリッドを作成するために、クアドラントノードのチェーンが作成されています。 最後の象限の[不透明度/輝度]パラメータに関数が作成されます。
...
[![SBSファイルアイコン](using-the-sampler-nodes.resources/using-the-sampler-nodes-06.png){width="64px"}](https://shared-assets.adobe.com/link/d5f9adf3-0bb5-49a1-4eb9-a0506d4f3f32)
