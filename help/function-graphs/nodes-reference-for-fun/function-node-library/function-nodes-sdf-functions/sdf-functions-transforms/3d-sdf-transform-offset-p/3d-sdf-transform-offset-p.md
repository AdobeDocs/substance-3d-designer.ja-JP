---
title: オフセットP
description: Designer > Substance合成グラフ>ノードリファレンスSubstance合成グラフ> Node library > SDF 関数 > Transform > Offset P
...
ワールド空間をベクトルに沿ってオフセットします。<br>出力変換されたワールド位置は、ほとんどのSDF 関数の<b>P</b>入力に接続して、この変換されたワールド空間で定義することができます。<br><br><i>ヒント：</i> P変換はチェーンを使用できますが、結果は演算の順序によって異なることに注意してください。
