---
title: 反転
description: Designer/Substance合成グラフ/ノードの参照Substance合成グラフ/ノードライブラリ/SDF 関数/トランスフォーム/反転
...
入力されたSDFシェイプに鏡像化の変換を適用します。<br>選択した軸に対して負のスケールを実行します。
...
| <b>ミラー軸</b> *Integer3* | Integer3を使用してミラー軸を設定します。<br>例： (1, 0, 0)はX軸を鏡像化します。<br><br><i>既定： (1, 0, 0)</i> |
