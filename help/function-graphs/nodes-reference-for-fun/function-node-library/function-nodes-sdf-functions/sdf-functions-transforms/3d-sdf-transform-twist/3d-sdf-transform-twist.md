---
title: ねじり（不正確）
description: Designer > Substance合成グラフ>ノードリファレンスSubstance合成グラフ> Node library > SDF 関数 > Transform > Twist (inexact)
...
SDFシェイプを、ローカルZ軸を中心に開始点と終了点の間で調整できる角度でツイストします。<br><br><i>注：</i>この変換関数は不正確であるため、レンダリング時に斑点が表示される可能性があります。
