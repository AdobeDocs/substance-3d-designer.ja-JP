...
らせんの近似値のSDF 関数です。らせんは、軸の周りの上向きの曲線に沿って巻かれた曲線に沿って円をスイープすることによって形成される図形です。<br><br><i>注意：</i>このSDF 関数は近似値であるため、レンダリング時に斑点が現れる可能性があります。
...
| <b>Windings</b> *フロート* | 0.5.<br>ステップでカーブが軸の周りを完全に巻く回数。つまり、0.5のHeight内でらせんが何回回転するかを指定します。<br><br><i>既定値： 4</i> |
| <b>中央位置</b> *浮動小数点3* | らせんの基点のワールドスペース位置。<br><br><i>既定値： (0, 0, 0)</i> |
