---
title: キャップ付き円錐
description: Designer > Substance合成グラフ>ノードリファレンスSubstance合成グラフ> Node library > SDF 関数 >プリミティブ>キャップコーン
...
| <b>中央位置</b> *浮動小数点3* | キャップされた円錐の基点のワールドスペース位置。<br><br><i>既定値： (0, 0, 0)</i> |
