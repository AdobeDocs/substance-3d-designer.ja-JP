---
title: 立方体
description: Designer > Substance合成グラフ >ノードリファレンスのSubstance合成グラフ >ノードライブラリ> SDF 関数 >プリミティブ>キューブ
...
| <b>ピボットの位置 （ローカル）</b> *浮動小数点3* | キューブのローカルピボットのワールド空間位置です。(0, 0, 0)は、ピボットをキューブの中心に配置します。<br><br><i>既定値： (0, 0, -0.5)</i> |
| <b>中央位置</b> *浮動小数点3* | キューブの基点のワールド空間位置です。<br><br><i>既定値： (0, 0, 0)</i> |
