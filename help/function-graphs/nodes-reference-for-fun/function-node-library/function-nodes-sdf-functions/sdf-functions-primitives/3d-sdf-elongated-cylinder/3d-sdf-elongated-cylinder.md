---
title: 細長い円柱
description: Designer > Substance合成グラフ>ノードリファレンスSubstance合成グラフ> Node library > SDF 関数 >プリミティブ> Proband cylinder
...
| <b>中央位置</b> *浮動小数点3* | 細長い円柱の基点のワールドスペース位置。<br><br><i>既定値： (0, 0, 0)</i> |
