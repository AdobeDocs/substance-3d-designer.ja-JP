---
title: 無限平面
description: Designer > Substance合成グラフ>ノードリファレンスSubstance合成グラフ> Node library > SDF 関数 >プリミティブ> Infinite plane
...
|  |  |
| :--- | :--- |
| <b>標準</b> *浮動小数点3* | 無限の平面の方向を制御するワールド空間の法線ベクトル。<br>ベクトルが正規化されています。<br><br><i>既定値： (0, 0, 1)</i> |
| <b>中央位置</b> *フロート* | 平面の基点のワールド空間の位置。平面の法線に沿ったワールド原点からの距離です。<br><br><i>既定値： 0</i> |
