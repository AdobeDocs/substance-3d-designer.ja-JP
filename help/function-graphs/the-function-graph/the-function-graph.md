...
![Substance関数のグラフ](the-function-graph.resources/image2015-12-18-11-29-28.png "Substance関数のグラフ")
...
![Substance関数グラフノード一覧](the-function-graph.resources/image2015-12-18-13-46-55.png "Substance関数グラフノード一覧")
...
![Substance関数グラフの出力ノード](the-function-graph.resources/image2015-12-18-13-49-43.png "Substance関数グラフの出力ノード")
...
![出力ノードを定義しています](the-function-graph.resources/setoutputnode.gif "出力ノードを定義しています")
...
![参照Substance関数グラフを開く](the-function-graph.resources/image2017-6-27-10-44-55.png "参照Substance関数グラフを開く")
...
![パッケージからSubstance関数グラフを削除](the-function-graph.resources/sbsdrag.gif "パッケージからSubstance関数グラフを削除")
