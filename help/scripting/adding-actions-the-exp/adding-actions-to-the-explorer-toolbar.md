...
breadcrumb-title: ''
description: Pythonスクリプティングを使用して、Substance 3D DesignerのExplorerツールバーにカスタムアクションを追加する方法について説明します。
helpx_creative_field: ""
helpx_description: Designer > Scripting > Adding actions to the Explorer toolbar
helpx_experience_level: ""
helpx_learn_topic: ""
helpx_tags: ""
title: エクスプローラーツールバーへのアクションの追加
...
# エクスプローラーツールバーへのアクションの追加

プラグインは、<b>SDUIMgr</b>クラスで使用可能なコールバックとメソッドを使用して、*カスタムアクション*&#x200B;を<b>エクスプローラー</b>ツールバーに追加できます。

## サンプルエクスプローラーツールバーアクションプラグイン
