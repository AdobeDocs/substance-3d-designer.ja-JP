...
[SDNode](../../scripting/scripting-api-reference/scripting-api-reference.md)クラスを使用すると、ユーザーは特定のノードに関する情報を取得できます。このプロパティには、[SDProperty](../../scripting/scripting-api-reference/scripting-api-reference.md)*<b></b>*クラスを使用してアクセスできます。 これらはすべて、読み取りまたは変更が可能です。
