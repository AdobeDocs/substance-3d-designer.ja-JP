...
代わりに、プラグインは<b>新しい[UIマネージャー](../scripting-api-reference/scripting-api-reference.md#ui-manager-sduimgr)オブジェクト</b>と<b>Qt for Python</b>を使用して、必要なユーザーインターフェイス要素を作成できます。
...
プラグインは<b>[UIマネージャー](../scripting-api-reference/scripting-api-reference.md#ui-manager-sduimgr)オブジェクト</b>を使用して、現在アクティブなグラフと選択範囲にアクセスできます。
