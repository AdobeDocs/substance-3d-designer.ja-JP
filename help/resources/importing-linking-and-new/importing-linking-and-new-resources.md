...
[Substance 3D Designer](https://www.adobe.com/jp/products/substance3d-designer.html)では、グラフで使用するリソースを3つのモードで取り込んだり、新しいリソースを作成したりできます。 これらのリソースには、[ビットマップ](../../resources/bitmap-resource/bitmap-resource.md)、[フォント](../../resources/vector-graphics-svg-res/vector-graphics-svg-resource.md)、[3D ベクターグラフィック](../3d-scene-resource/3d-scene-resource.md)および[シーン](../../resources/font-resource/font-resource.md)など、様々な種類があります。 このページでは、様々な方法と、それらが最適に使用されるタイミングについて説明します。

すべてのメソッドにアクセスするには、エクスプローラーのパッケージで[RMB]をクリックします。
...
Designerで同時に作業しながら、外部エディターを使用してリソースを更新する必要がある場合は、リンクが最適です。 ベイク処理マップが最も良い例です。Designerの参照ビットマップを外部のベイク処理アプリケーションとして使用し、これらのファイルが変更されるとすぐに、グラフを自動的に再読み込みして更新することができます。 同様に、3D シーンはリンクすることしかできないため、3Dアプリケーションから新しいFBXファイルを書き出すたびに、Designerでは3Dビューで使用されているメッシュが自動的に更新されます。 このメッシュからマップをベイクする場合は、ベイクプロセスをやり直す必要があります。RMBをクリックして「すべてのベイク済みマップを更新」を選択するのが理想的です。

## リソースの削除

パッケージからリソースを削除するときに、<b>項目の削除の確認</b>ダイアログが表示されます。 [グラフ](../../compositing-graphs/substance-compositing-graphs.md)で使用されている[リソース](../../compositing-graphs/creating-compositing-gra/graph-instances-sub-gra/graph-instances-sub-graphs.md)および[ビットマップグラフインスタンス](../../resources/bitmap-resource/bitmap-resource.md)など、削除中のアイテムが他のリソース&#x200B;*で*&#x200B;参照されている場合、ダイアログにこれらのアイテムの&#x200B;*警告と一覧*&#x200B;が表示されます。
...
![&#39;使用中のリソースが削除されました&#39;警告](importing-linking-and-new-resources.resources/importing-linking-and-new-resources-01.png "&#39;使用中のリソースが削除されました&#39;警告"){width="512px"}
