...
[エクスプローラー](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/the-explorer-129368147.html)でパッケージの[RMB]をクリックし、パッケージのコンテキストメニューの<b>インポート/AxF</b>に移動します。
...
既存のAxFファイルに書き出す場合、そのリソースはグラフ出力を使用して更新されます。 Designerは、<b>Usage</b>と同じIDを持つ[Output](../../compositing-graphs/nodes-reference-for-com/atomic-nodes/output/output.md)ノードとリソースIDを一致させます。
