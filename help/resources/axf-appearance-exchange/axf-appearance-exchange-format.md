...
[![AxFファイルアイコン](axf-appearance-exchange-format.resources/axf-appearance-exchange-format-01.png)](https://www.xrite.com/axf)
...
![AxF:ホーム画面から読み込みを開始](axf-appearance-exchange-format.resources/axf-appearance-exchange-format-02.png "AxF:ホーム画面から読み込みを開始"){width="600px"}
...
![AxF:エクスプローラーからのインポートを開始](axf-appearance-exchange-format.resources/axf-appearance-exchange-format-03.png "AxF:エクスプローラーからのインポートを開始"){width="600px"}
...
![AxF:ダイアログのインポート](axf-appearance-exchange-format.resources/axf-appearance-exchange-format-04.png "AxF:ダイアログのインポート")
...
![AxF:インポートプロセスのパッケージ結果](axf-appearance-exchange-format.resources/axf-appearance-exchange-format-05.png "AxF:インポートプロセスのパッケージ結果")
...
![AxF:インポートダイアログにテンプレートを追加](axf-appearance-exchange-format.resources/axf-appearance-exchange-format-06.png "AxF:インポートダイアログにテンプレートを追加")
...
![AxF: Substanceグラフテンプレート](axf-appearance-exchange-format.resources/axf-appearance-exchange-format-07.png "AxF: Substanceグラフテンプレート")
...
![AxF: Substanceグラフパラメーター](axf-appearance-exchange-format.resources/axf-appearance-exchange-format-08.png "AxF: Substanceグラフパラメーター")
...
![AxFのエクスポート](axf-appearance-exchange-format.resources/axf-appearance-exchange-format-09.gif)
...
[グラフビュー](../../interface/the-graph-view/the-graph-view.md)ツールバーで、![](axf-appearance-exchange-format.resources/axf-appearance-exchange-format-10.jpg) <b>ツール</b>メニューを開き、[<b>出力のエクスポート…</b>]オプションを選択してダイアログを表示し、[<b>AxF</b>]タブを選択します。

</td>
<td width="100.00%" style="border: 0;" valign="top">

![AxF:グラフビューのツールバーの[エクスポート]オプション](axf-appearance-exchange-format.resources/axf-appearance-exchange-format-11.png "AxF:グラフビューのツールバーの[エクスポート]オプション")
...
![AxF：書き出しダイアログ](axf-appearance-exchange-format.resources/axf-appearance-exchange-format-12.png "AxF：書き出しダイアログ")
...
![AxF: Substanceグラフの出力の使用状況](axf-appearance-exchange-format.resources/axf-appearance-exchange-format-13.png "AxF: Substanceグラフの出力の使用状況")
...
![AxF:コンバージョン用に表示](axf-appearance-exchange-format.resources/axf-appearance-exchange-format-14.gif "AxF:コンバージョン用に表示")
...
![AxF: SVBRDF GLSLFXシェーダー](axf-appearance-exchange-format.resources/axf-appearance-exchange-format-15.png "AxF: SVBRDF GLSLFXシェーダー"){width="600px"}
...
![AxF:エディション用に表示](axf-appearance-exchange-format.resources/axf-appearance-exchange-format-16.gif "AxF:エディション用に表示")
