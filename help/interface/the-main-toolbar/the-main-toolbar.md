...
* <b>新しいSubstanceグラフ…:</b>(Ctrl + N)新しい[Substanceグラフ](../../compositing-graphs/substance-compositing-graphs.md)を設定できる[新しいSubstanceグラフ](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/create-a-graph-102400068.html)ウィンドウを表示します。
...
<b>エクスプローラー：</b> [エクスプローラーウィンドウの表示と非表示を切り替えます。](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/the-explorer-129368147.html)

<b>グラフ：</b> [グラフウィンドウ](../../interface/the-graph-view/the-graph-view.md)の表示/非表示を切り替えます。

<b>パラメーター：</b> [プロパティウィンドウ](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/parameters-ui-129368153.html)の表示/非表示を切り替えます。
...
<b>2Dビュー：</b> [2Dビューの表示/非表示を切り替えます。](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/2d-view-deprecated-129368155.html)
...
<b>Substance 3Dアセット：</b>サブスクライバー（以前のSubstance Source）は、[プレミアム3Dコンテンツ](https://helpx.adobe.com/substance-3d/unlisted/assets.html)を参照してください。

<b>Substance 3Dコミュニティアセット:</b> [無料のコミュニティアセット](https://helpx.adobe.com/substance-3d/unlisted/community-assets.html) （以前のSubstance share）を参照できます。
