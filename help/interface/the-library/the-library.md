...
![ライブラリ](the-library.resources/library-main.png "ライブラリ")
...
* [3D シーン](../../resources/3d-scene-resource/3d-scene-resource.md)、[関数グラフ](../../function-graphs/the-function-graph/the-function-graph.md)、[フォント](../../resources/font-resource/font-resource.md)および[AxF](../../resources/axf-appearance-exchange/axf-appearance-exchange-format.md)ファイルは、各種類の&#x200B;*汎用アイコン*&#x200B;で表されます
...
![ライブラリからノードを削除しています](the-library.resources/library-create-node.gif "ライブラリからノードを削除しています")
...
「<b>検索</b>」バーの横にある「![](the-library.resources/library-icon-search-filter.png) <b>フィルターの条件…</b>」アイコンを使用して、検索結果を&#x200B;*グラフの種類*&#x200B;でフィルターできます。
...
![ライブラリでのアセット検索](the-library.resources/library-search-2.png "ライブラリでのアセット検索")
...
![](the-library.resources/library-icon-view-mode.png) <b>表示モード</b>ドロップダウンボタンを使用して、コンテンツ項目の表示サイズを選択できます。

</td>
<td width="25.00%" style="border: 0;" valign="top">

![ライブラリアセット表示モード](the-library.resources/library-display-modes.png "ライブラリアセット表示モード")
...
![](the-library.resources/library-icon-toggle-label.png) **ラベルの切り替え**&#x200B;ボタンを使用すると、ノードのラベルを表示または非表示にできます。

</td>
<td style="border: 0;" valign="top">

![ラベルの切り替え](the-library.resources/library-toggle-label.png "ラベルの切り替え")
...
![アセット情報のツールヒント](the-library.resources/library-item-tooltip.png "アセット情報のツールヒント")
...
![](the-library.resources/library-icon-favoritepng.png) <b>[お気に入りに追加]</b>ボタンを使用すると、<b>コンテンツ</b>セクションの任意のアイテムを<b>お気に入り</b>リストに追加できます。 このボタンを使用すると、このリストにコンテンツが既に追加されている場合は、*削除*&#x200B;することもできます。\
この一覧にコンテンツが追加されると、そのコンテンツは<b>Library</b>の<b>お気に入り</b>カテゴリで利用可能になり、グラフ内のノードを検索する際に<b>Node</b>メニューリストの&#x200B;*top*&#x200B;に表示されます（検索語が一致する場合）。

</td>
<td style="border: 0;" valign="top">

![ライブラリのお気に入り](the-library.resources/library-favourites.png "ライブラリのお気に入り")
