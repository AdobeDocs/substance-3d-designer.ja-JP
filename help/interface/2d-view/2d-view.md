...
2D ビューに画像を表示するには、*LMB*&#x200B;をダブルクリックします。

* ...[エクスプローラー](../../interface/the-explorer-window/the-explorer-window.md)の[ビットマップ](../../resources/bitmap-resource/bitmap-resource.md)または[ベクターグラフィック](../../resources/vector-graphics-svg-res/vector-graphics-svg-resource.md)リソース上
* [グラフビュー](../../interface/the-graph-view/the-graph-view.md)内のノードまたはノードコネクター上

[エクスプローラー](../../interface/the-explorer-window/the-explorer-window.md)パネルの[リソース](../../resources/resources.md)の&#x200B;*LMB*、またはビューポートのノードの&#x200B;*RMB*&#x200B;を押して、画像をグラフビューに直接&#x200B;*ドラッグアンドドロップ*&#x200B;することもできます。

グラフビューでは、[<b>2D ビューの出力を表示</b>]コンテキストメニューオプションを使用して2D ビューにイメージを送ることができます。このオプションには、[*RMB*...]をクリックしてアクセスします。

* ...を&#x200B;*ノード*&#x200B;上に置き、*そのノードの出力*&#x200B;を表示します。 ノードに複数の出力がある場合は、サブメニューから目的の出力を選択します
* ...グラフビューの&#x200B;*空きスペース*&#x200B;に&#x200B;*そのグラフの出力*&#x200B;を表示します。 グラフに複数の出力がある場合は、サブメニューから目的の出力を選択します

グラフを読み込むと、その&#x200B;*最初の出力*&#x200B;は、既定で2D ビューに自動的に表示されます。 この動作は、[環境設定](../../interface/preferences-window/preferences-window.md)で無効にできます。 <b>編集/環境設定/グラフ/Substance合成グラフ</b>に移動し、*グラフを開くときに<b>出力を2Dビューで表示</b>する*&#x200B;をオフにします。
...
メッシュに<b>複数のUV セット</b>がある場合は、目的のUVをドロップダウンチェックリストで選択できます。このチェックリストを開くには、ボタンの「UV」ラベルの横にある矢印をクリックします。
...
* <b>8ビット</b>: 0 ～ 255 整数 / 0.0 ～ 1.0浮動小数点

* <b>16ビット</b>: 0 ～ 65532 整数 / 0.0 ～ 1.0浮動小数点
...
**ディスプレイ**&#x200B;ツールバーは、既定では&#x200B;**2D ビュー**&#x200B;パネルの&#x200B;*下部*&#x200B;にあり、ビューポートでの画像の表示方法を制御できます。
