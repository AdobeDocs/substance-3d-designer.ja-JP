...
プロパティパネルは、[エクスプローラウィンドウ](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/the-explorer-129368147.html)の選択の変更にも応答します。 空の領域をダブルクリックする代わりに、グラフを選択する別の方法として使用できます。また、パッケージと[リソース](../../resources/resources.md)のプロパティを変更することもできます。
